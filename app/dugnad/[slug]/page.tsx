    ...
    <div className="max-w-[1280px] m-auto">
      <div className="flex h-[350px]">
        ...
        <div className="w-1/3 bg-black flex flex-col items-center gap-3 justify-center">
          ...
          <Link href={`/profil/${dugnadOwner.id}`}>
