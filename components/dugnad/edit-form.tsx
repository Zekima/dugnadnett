...
const EditForm = ({ categories, dugnad }: any) => {
  ...
  const [selectedCategories, setSelectedCategories] = useState(dugnad.categories.map((category: any) => category.name))
  ...
  return (
    ...
    <div className="h-screen flex justify-center relative">
      <div className="w-[500px]">
        ...
        <h1 className="text-2xl py-4 font-semibold text-center">Rediger Dugnad</h1>
        <Form {...form}>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <BadgeSelect {...field} categories={categories} value={selectedCategories} onChange={setSelectedCategories} />
                  </FormControl>
                </FormItem>
              )}
            />
